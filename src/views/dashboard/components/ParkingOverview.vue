<template>
  <el-card class="parking-overview" shadow="hover">
    ...
    <el-select v-model="selectedCity" placeholder="请选择城市" class="city-select" @change="focusCity" clearable>
      <el-option label="全局视图" value="global" />
      <el-option v-for="(coord, city) in cityCoordinates" :key="city" :label="city" :value="city" />
    </el-select>
